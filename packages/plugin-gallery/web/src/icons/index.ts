...
export { default as MasonryIconNew } from './MasonryIconNew';
export { default as CollageIconNew } from './CollageIconNew';
export { default as ThumbnailsIconNew } from './ThumbnailsIconNew';
export { default as SlideshowIconNew } from './SlideshowIconNew';
export { default as PanoramaIconNew } from './PanoramaIconNew';
export { default as SlidesIconNew } from './SlidesIconNew';
export { default as ColumnsIconNew } from './ColumnsIconNew';
